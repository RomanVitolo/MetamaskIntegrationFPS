...
namespace MetaMask
{
    ...
    public class MetaMaskWallet : IDisposable
    {
        ...
        protected void OnMessageReceived(string response)
        {
            ...
            else
            {
                ...
                if (decryptedMessage.TryGetProperty("data", out var data))
                {
                    ...
                    MetaMaskProvider metaMaskProvider = JsonConvert.DeserializeObject<MetaMaskProvider>(decryptedJson);
                    Debug.Log("Wallet Address: " + metaMaskProvider.Data.Result[0]);
                    CurrentWalletAddress = metaMaskProvider.Data.Result[0];
                }
                else
                {
        ...
        public static string CurrentWalletAddress = null;
